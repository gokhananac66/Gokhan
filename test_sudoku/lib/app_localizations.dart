...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'autoCheckFound': 'Auto-check found',
      'combo': 'Combo',
      'time': 'Time',
      'freeze': 'Freeze',
      'timeFrozen': 'Time frozen for',
      'timeFreezeEnded': 'Time freeze ended',
      'seconds': 'seconds',
      'yourTurn': 'YOUR TURN',
      ...
      'deleteAccountFinal': 'This is your last chance. Your account and all data will be permanently deleted.',
      'deleteAccountConfirm': 'Yes, Delete My Account',
      'delete': 'Delete',
      'accountDeleted': 'Your account has been deleted successfully.',
      'reAuthRequired': 'Please sign out and sign in again, then try deleting your account.',
    ...
    'tr': {
      ...
      'autoCheckFound': 'Otomatik kontrol buldu',
      'combo': 'Kombo',
      'time': 'Süre',
      'freeze': 'Dondur',
      'timeFrozen': 'Süre donduruldu',
      'timeFreezeEnded': 'Süre dondurma bitti',
      'seconds': 'saniye',
      ...
      'deleteAccountWarning': 'Bu işlem kalıcıdır ve geri alınamaz. Tüm verileriniz silinecektir.',
      'willBeDeleted': 'Silinecek veriler',
      'areYouSure': 'Emin misiniz?',
      'deleteAccountFinal': 'Bu son şansınız. Hesabınız ve tüm verileriniz kalıcı olarak silinecek.',
      'deleteAccountConfirm': 'Evet, Hesabımı Sil',
      'delete': 'Sil',
      'accountDeleted': 'Hesabınız başarıyla silindi.',
      'reAuthRequired': 'Lütfen çıkış yapıp tekrar giriş yapın, ardından hesabınızı silmeyi deneyin.',
