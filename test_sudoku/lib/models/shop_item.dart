...
class ShopItems {
  static final List<ShopItem> all = [
    ...
    ShopItem(
      ...
      nameEn: '2x Score',
      nameTr: '2x Puan',
      descriptionEn: 'Double points for 1 game',
      descriptionTr: '1 oyun için çift puan',
      icon: '⚡',
      price: 75,
    ...
    ShopItem(
      ...
      descriptionEn: 'Automatically find errors',
      descriptionTr: 'Hataları otomatik bul',
      icon: '🔍',
      price: 100,
    ...
    ShopItem(
      ...
      nameEn: 'Time Freeze',
      nameTr: 'Zaman Dondur',
      descriptionEn: 'Freeze timer for 1 minute (Race mode)',
      descriptionTr: 'Süreyi 1 dakika dondur (Race modu)',
      icon: '⏸️',
      price: 80,
      color: Color(0xFF00BCD4),
    ),
