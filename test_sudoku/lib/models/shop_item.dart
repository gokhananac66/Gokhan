...
class ShopItems {
  static final List<ShopItem> all = [
    ...
    // === THEMES (9 Premium Themes) ===
    ShopItem(
      id: 'theme_ocean',
      category: ShopCategory.themes,
      nameEn: 'Ocean',
      nameTr: 'Okyanus',
      descriptionEn: 'Calming teal tones',
      descriptionTr: 'Sakinleştirici turkuaz tonlar',
      icon: '🌊',
      price: 200,
    ...
    ShopItem(
      ...
      nameEn: 'Sunset',
      nameTr: 'Gün Batımı',
      descriptionEn: 'Warm coral gradients',
      descriptionTr: 'Sıcak mercan tonları',
      icon: '🌅',
      price: 200,
    ...
    ShopItem(
      ...
      nameEn: 'Forest',
      nameTr: 'Orman',
      descriptionEn: 'Natural green palette',
      descriptionTr: 'Doğal yeşil palet',
      icon: '🌲',
      price: 200,
    ...
    ShopItem(
      ...
      nameEn: 'Galaxy',
      nameTr: 'Galaksi',
      descriptionEn: 'Deep purple cosmos',
      descriptionTr: 'Derin mor kozmos',
      icon: '🌌',
      price: 250,
    ...
    ShopItem(
      ...
      nameEn: 'Midnight',
      nameTr: 'Gece Yarısı',
      descriptionEn: 'Dark blue elegance',
      descriptionTr: 'Koyu mavi zarafet',
      icon: '🌙',
      price: 250,
    ...
    ShopItem(
      ...
      nameEn: 'Rose',
      nameTr: 'Gül',
      descriptionEn: 'Soft pink harmony',
      descriptionTr: 'Yumuşak pembe uyum',
      icon: '🌹',
      price: 250,
    ...
    ShopItem(
      ...
      nameEn: 'Lavender',
      nameTr: 'Lavanta',
      descriptionEn: 'Light purple serenity',
      descriptionTr: 'Açık mor huzur',
      icon: '💜',
      price: 200,
    ...
    ShopItem(
      ...
      nameEn: 'Earth',
      nameTr: 'Toprak',
      descriptionEn: 'Natural brown tones',
      descriptionTr: 'Doğal kahverengi tonlar',
      icon: '🏔️',
      price: 200,
    ...
    ShopItem(
      ...
      nameEn: 'Mint',
      nameTr: 'Nane',
      descriptionEn: 'Fresh mint green',
      descriptionTr: 'Taze nane yeşili',
      icon: '🍃',
      price: 200,
